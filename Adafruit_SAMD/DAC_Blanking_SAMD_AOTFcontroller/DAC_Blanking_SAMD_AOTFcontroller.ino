...
byte writeZeros()
{
    ...
    analogWrite(A0, 0);      // New for DAC Blanking
    analogWrite(A1, 0);      // New for DAC Blanking
    digitalWrite(ch3, 0);
    digitalWrite(ch4, 0);
    digitalWrite(ch5, 0);
    digitalWrite(ch6, 0);
...
void writePattern(byte pattern_)
{
  ...
  //digitalWrite(ch1, bitRead(pattern_,0));   Removed for DAC blanking
  //digitalWrite(ch2, bitRead(pattern_,1));   Removed for DAC blanking
